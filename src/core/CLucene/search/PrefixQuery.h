...
* is built by QueryParser for input like <code>app*</code>. */
    ...
    public:
      class PrefixGenerator;
    	...
    	PrefixFilter(CL_NS(index)::Term::Pointer prefix);
    	~PrefixFilter();
		...
		CL_NS(index)::Term::Pointer getPrefix() const;
    };
CL_NS_END
#endif
