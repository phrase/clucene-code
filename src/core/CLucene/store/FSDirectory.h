...
CL_CLASS_DEF(util,StringBuffer)
   ...
   */
    ...
    * create a new index.
    */
		static _CL_DEPRECATED( getDirectory(file,lockFactory) )FSDirectory::Pointer getDirectory(const char* file, const bool create, LockFactory* lockFactory=NULL);
    ...
    */
		static FSDirectory::Pointer getDirectory(const char* file,LockFactory* lockFactory=NULL);
