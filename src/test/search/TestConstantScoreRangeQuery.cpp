...
{
private:
    Directory::Pointer m_pSmall;

public:
    TestConstantScoreRangeQuery( CuTest * _tc ) : BaseTestRangeFilter( _tc ) {}
    ...
    void setUp()
    {
        ...
        m_pSmall.reset(new RAMDirectory());
    ...
    void testBooleanOrderUnAffected()
    {
        ...
        Term::Pointer pLower(new Term( _T( "data" ), _T( "1" )));
        Term::Pointer pUpper(new Term( _T( "data" ), _T( "4" )));
