...
{
    directory.reset(new RAMDirectory());
...
void TestBasics::testTerm()
{
    ...
    Term::Pointer term(new Term( _T( "field" ), _T( "seventy" )));
...
{
    Term::Pointer term(new Term( _T( "field" ), _T( "seventish" )));
    Query * query = new TermQuery( term );
...
void TestBasics::testPhrase()
{
    ...
    Term::Pointer term1(new Term( _T( "field" ), _T( "seventy" )));
    Term::Pointer term2(new Term( _T( "field" ), _T( "seven" )));
...
{
    Term::Pointer term1(new Term( _T( "field" ), _T( "seventish" )));
    Term::Pointer term2(new Term( _T( "field" ), _T( "sevenon" )));
...
{
    Term::Pointer term1(new Term( _T( "field" ), _T( "sevento" )));
    Term::Pointer term2(new Term( _T( "field" ), _T( "sevenly" )));
...
void TestBasics::testSpanNearUnordered()
{
    ...
    Term::Pointer term1(new Term( _T( "field" ), _T( "nine" )));
    Term::Pointer term2(new Term( _T( "field" ), _T( "six" )));
...
void TestBasics::testSpanNot()
{
    ...
    Term::Pointer term1(new Term( _T( "field" ), _T( "eight" )));
    Term::Pointer term2(new Term( _T( "field" ), _T( "one" )));
    Term::Pointer term3(new Term( _T( "field" ), _T( "forty" )));
...
void TestBasics::testSpanWithMultipleNotMany()
{
    ...
    Term::Pointer term2(new Term( _T( "field" ), _T( "one" )));
    Term::Pointer term3(new Term( _T( "field" ), _T( "forty" )));
    Term::Pointer term4(new Term( _T( "field" ), _T( "sixty" )));
    Term::Pointer term5(new Term( _T( "field" ), _T( "eighty" )));
...
void TestBasics::testNpeInSpanNearWithSpanNot()
{
    ...
    Term::Pointer term1(new Term( _T( "field" ), _T( "eight" )));
    Term::Pointer term2(new Term( _T( "field" ), _T( "one" )));
    Term::Pointer hun(new Term( _T( "field" ), _T( "hundred" )));
    Term::Pointer term3(new Term( _T( "field" ), _T( "forty" )));
...
void TestBasics::testNpeInSpanNearInSpanFirstInSpanNot()
{
    ...
    Term::Pointer hun(new Term( _T( "field" ), _T( "hundred" )));
    Term::Pointer term40(new Term( _T( "field" ), _T( "forty" )));
...
void TestBasics::testSpanFirst()
{
    ...
    Term::Pointer term1(new Term( _T( "field" ), _T( "five" )));
...
void TestBasics::testSpanOr()
{
    ...
    Term::Pointer term1(new Term( _T( "field" ), _T( "thirty" )));
    Term::Pointer term2(new Term( _T( "field" ), _T( "three" )));
    Term::Pointer term3(new Term( _T( "field" ), _T( "forty" )));
    Term::Pointer term4(new Term( _T( "field" ), _T( "seven" )));
...
void TestBasics::testSpanExactNested()
{
    ...
    Term::Pointer term1(new Term( _T( "field" ), _T( "three" )));
    Term::Pointer term2(new Term( _T( "field" ), _T( "hundred" )));
    Term::Pointer term3(new Term( _T( "field" ), _T( "thirty" )));
...
void TestBasics::testSpanNearOr()
{
    ...
    Term::Pointer term1(new Term( _T( "field" ), _T( "six" )));
    Term::Pointer term2(new Term( _T( "field" ), _T( "seven" )));
...
void TestBasics::testSpanComplex1()
{
    ...
    Term::Pointer termSix(new Term( _T( "field" ), _T( "six" )));
    Term::Pointer termHun(new Term( _T( "field" ), _T( "hundred" )));
    Term::Pointer termSev(new Term( _T( "field" ), _T( "seven" )));
