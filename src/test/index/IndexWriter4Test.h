...
public:
  ...
  IndexWriter4Test(CL_NS(store)::Directory::Pointer d, CL_NS(analysis)::Analyzer* a, const bool create);
  IndexWriter4Test(CL_NS(store)::Directory::Pointer d, bool autocommit, CL_NS(analysis)::Analyzer* a, const bool create);
