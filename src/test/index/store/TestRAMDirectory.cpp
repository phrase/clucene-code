...
void checkDir(CuTest *tc, MockRAMDirectory::Pointer ramDir) {
...
void testRAMDirectory (CuTest *tc) {
    ...
    Directory::Pointer dir = FSDirectory::getDirectory(indexDir);
    MockRAMDirectory::Pointer ramDir(new MockRAMDirectory(dir));
...
void testRAMDirectoryString (CuTest *tc) {
    ...
    MockRAMDirectory::Pointer ramDir(new MockRAMDirectory(indexDir));
