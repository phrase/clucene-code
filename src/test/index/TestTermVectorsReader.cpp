...
CL_NS_USE(util);
  ...
  CL_NS(store)::MockRAMDirectory::Pointer dir(new CL_NS(store)::MockRAMDirectory);
  std::string seg;
  ...
  public:
    MyIndexWriter(CL_NS(store)::Directory::Pointer d, CL_NS(analysis)::Analyzer* a, const bool create) :
